...
import { type IUpdateMe } from '@/types/authType'
...
export default function ProfilePage() {
  const { user, isLoading, isError, error, logout } = useGetMe()
  const { mutate: updateMe, isPending } = useUpdateMe()
  const { register, handleSubmit, formState: {errors}, setValue, reset} = useForm<IUpdateMe>()
